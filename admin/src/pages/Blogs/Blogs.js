...
function Blogs(props) {
  ...
  function handleUpload(e) {
    ...
    const uploadTask = storage.ref(`/images/blog/${time + "_" + file.name}`).put(file);
  ...
  const getPostData = () => {
    // Axios
    // .get(`https://qirah-dashboard-default-rtdb.firebaseio.com/blog.json`)
